...
const EN = {
  ...
  products: [{
    id: "p01",
    name: "Hagi Tea Bowl, Plum",
    cat: "ceramics",
    maker: "Sakata Kiln, Yamaguchi",
    price: 38500,
    swatch: "#c8a896"
  }, {
    id: "p02",
    name: "Negoro Soup Bowl",
    cat: "lacquerware",
    maker: "Tsutsumi Urushi, Wajima",
    price: 24800,
    swatch: "#8b3a30"
  }, {
    id: "p03",
    name: "Aogami No. 2 Petty Knife",
    cat: "blades",
    maker: "Nakaya Forge, Sakai",
    price: 46000,
    swatch: "#2c2c2c"
  }, {
    id: "p04",
    name: "Sashiko Selvedge Jacket",
    cat: "textiles",
    maker: "Kojima Mills, Okayama",
    price: 89000,
    swatch: "#1c2a3e"
  }, {
    id: "p05",
    ...
    cat: "wood",
    maker: "Yoshino Joinery, Nara",
    price: 14200,
    swatch: "#d8c8a4"
  }, {
    id: "p06",
    name: "Echizen Letter Set",
    cat: "paper",
    maker: "Iwano Heizaburō, Fukui",
    price: 9800,
    swatch: "#f0e8d4"
  }, {
    id: "p07",
    name: "Tetsubin Iron Kettle",
    cat: "tea",
    maker: "Suzuki Morihisa, Morioka",
    price: 78000,
    swatch: "#3a3a36"
  }, {
    id: "p08",
    name: "Tsuiki Copper Cup",
    cat: "metal",
    maker: "Gyokusendō, Tsubame",
    price: 32000,
    swatch: "#a86a48"
  }, {
    id: "p09",
    name: "Edo Kiriko Tumbler, Indigo",
    cat: "glass",
    maker: "Hanashō, Tokyo",
    price: 28000,
    swatch: "#1c3550"
    ...
    id: "p10",
    name: "Indigo Noragi Coat",
    cat: "garments",
    maker: "Watanabe Atelier, Kyoto",
    price: 64000,
    swatch: "#1a2a3a"
  }, {
    id: "p11",
    name: "Karatsu Sake Cup, Pair",
    cat: "ceramics",
    maker: "Nakazato Tarōemon, Saga",
    price: 18400,
    swatch: "#a89888"
  }, {
    id: "p12",
    name: "Honyaki Gyuto, 240mm",
    cat: "blades",
    maker: "Konosuke, Sanjō",
    price: 128000,
    swatch: "#1c1c1c"
  }],
  trendingIds: ["p07", "p03"],
  ...
  journal: [{
    ...
    kind: "Story",
    date: "Apr 18, 2026",
    title: "The 14th-generation potter who refuses to repeat himself",
    maker: "Sakata Kiln"
  }, {
    id: "j02",
    kind: "Collection",
    date: "Apr 09, 2026",
    title: "Spring 2026: Twelve makers, one season",
    maker: "JMC Editorial"
  }, {
    id: "j03",
    kind: "Process",
    date: "Mar 28, 2026",
    title: "How a Sakai blade is forged across three workshops",
    maker: "Nakaya Forge"
  }, {
    id: "j04",
    kind: "Travel",
    date: "Mar 14, 2026",
    title: "A studio visit in Wajima, six months after the quake",
    maker: "Tsutsumi Urushi"
  }, {
    id: "j05",
    kind: "Maker",
    date: "Feb 26, 2026",
    title: "On indigo, patience, and the color of midnight",
    maker: "Watanabe Atelier"
  }, {
    id: "j06",
    kind: "Process",
    date: "Feb 12, 2026",
    title: "Why Hinoki cutting boards heal themselves",
    maker: "Yoshino Joinery"
  }],
  pillars: [{
    icon: "shipping",
    title: "Worldwide Delivery",
    desc: "DHL Express to 80+ countries"
  }, {
    icon: "returns",
    title: "30-day Returns",
    desc: "Free return on full-price orders"
  }, {
    icon: "service",
    title: "Concierge Support",
    desc: "Available daily via WhatsApp & email"
  }, {
    icon: "authentic",
    title: "Authenticity Card",
    desc: "Each piece signed by its maker"
  }],
  story: {
  ...
  footer: {
    ...
    columns: [{
      ...
      links: [{
        label: "Ceramics",
        href: "shop-category.html?c=ceramics"
      }, {
        label: "Blades",
        href: "shop-category.html?c=blades"
      }, {
        label: "Lacquerware",
        href: "shop-category.html?c=lacquerware"
      }, {
        label: "Textiles",
        href: "shop-category.html?c=textiles"
      }, {
        label: "All",
        href: "shop.html"
      }]
      ...
      links: [{
        ...
        label: "Shipping",
        href: "contact.html#shipping"
      }, {
        label: "Returns",
        href: "contact.html#returns"
      }]
    }],
    about: {
      title: "About JMC",
...
const JA = {
  ...
  categories: [{
    ...
    id: "blades",
    label: "刃物",
    labelJp: "Knives & Blades",
    count: 22,
    accent: "#3a3a3a"
  }, {
    id: "textiles",
    label: "織物・デニム",
    labelJp: "Textiles & Denim",
    count: 31,
    accent: "#23354d"
  }, {
    id: "wood",
    label: "木工・指物",
    labelJp: "Wood & Joinery",
    count: 16,
    accent: "#8a6a4b"
  }, {
    id: "paper",
    label: "和紙・文具",
    labelJp: "Stationery & Paper",
    count: 14,
    accent: "#d8c8a8"
  }, {
    id: "tea",
    label: "茶道具",
    labelJp: "Tea & Tea Ware",
    count: 19,
    accent: "#4a5a3a"
  }, {
    id: "metal",
    label: "金工・装身具",
    labelJp: "Jewelry & Metalwork",
    count: 12,
    accent: "#9a8050"
  }, {
    id: "glass",
  ...
  journal: [{
    ...
    kind: "ストーリー",
    date: "2026年4月18日",
    title: "繰り返さない14代目、その作陶哲学",
    maker: "Sakata Kiln"
  }, {
    id: "j02",
    kind: "コレクション",
    date: "2026年4月9日",
    title: "Spring 2026 — 12人の作り手、ひとつの季節",
    maker: "JMC編集部"
  }, {
    id: "j03",
    kind: "プロセス",
    date: "2026年3月28日",
    title: "三つの工房をまたぐ、堺の刃の鍛造",
    maker: "Nakaya Forge"
  }, {
    id: "j04",
    kind: "旅",
    date: "2026年3月14日",
    title: "震災から半年、輪島の工房を訪ねて",
    maker: "Tsutsumi Urushi"
  }, {
    id: "j05",
    kind: "作り手",
...
window.JMC_SET_LOCALE = loc => {
  ...
  try {
    localStorage.setItem("jmc_locale", loc);
  } catch (e) {}
  document.documentElement.setAttribute("lang", loc);
  window.dispatchEvent(new CustomEvent("jmc:locale", {
    detail: loc
  }));
};
